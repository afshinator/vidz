...
CREATE INDEX "watchlist_added_at_idx" ON "watchlist" USING btree ("added_at");--> statement-breakpoint
CREATE INDEX "watchlist_user_video_idx" ON "watchlist" USING btree ("user_id","video_id");--> statement-breakpoint
CREATE INDEX "video_notes_user_video_idx" ON "video_notes" USING btree ("user_id","video_id");